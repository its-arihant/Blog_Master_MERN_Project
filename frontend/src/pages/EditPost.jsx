  ...
  return (
    <div>
      ...
      <div className="px-6 md:px-8 lg:px-16 mt-8">
        <h1 className="font-bold md:text-3xl text-2xl text-center text-black mb-6">
          Update a Post
        </h1>
        <form className="w-full flex flex-col space-y-4 md:space-y-6">
          <input
            ...
            type="text"
            placeholder="Enter post title"
            className="px-4 py-3 outline-none border border-gray-300 rounded-md focus:ring-2 focus:ring-gray-600 transition-all w-full md:w-[80%] mx-auto"
          />
          <input
            onChange={(e) => setFile(e.target.files[0])}
            type="file"
            className="px-4 py-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-gray-600 transition-all w-full md:w-[80%] mx-auto"
          />
          <div className="flex flex-col space-y-4">
            <div className="flex items-center space-x-4">
              <input
                value={cat}
                onChange={(e) => setCat(e.target.value)}
                className="px-4 py-3 outline-none border border-gray-300 rounded-md flex-1 focus:ring-2 focus:ring-gray-600 transition-all"
                placeholder="Enter post category"
                type="text"
              />
              <button
                onClick={addCategory}
                type="button"
                className="bg-black text-white px-4 py-3 font-semibold rounded-md hover:bg-gray-800 transition-all"
              >
                Add
              </button>
            </div>
          ...
          <button
            onClick={handleUpdate}
            className="bg-black w-full md:w-[20%] mx-auto text-white font-semibold px-4 py-3 text-lg rounded-md hover:bg-gray-800 transition-all"
          >
            Update
          </button>
        </form>
